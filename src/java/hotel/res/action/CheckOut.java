...
public class CheckOut {
    ...
    public String execute(){
        try{
        PreparedStatement pst=conn().prepareStatement("update booking set checkout_time=curtime() where id=?;");
        ...
        pst.setInt(1, rid);
        pst.executeUpdate();
        pst=conn().prepareStatement("update booking set status='Checked_out' where id=?;");
        pst.setInt(1,Integer.parseInt(id));
        pst.executeUpdate();
        return "SUCCESS";
        }
